...
public class FormLaundryCustomer extends javax.swing.JFrame 
{
    public FormLaundryCustomer() {
        initComponents();
    }
    ...
    public static void main(String args[]) 
    {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormLaundryCustomer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormLaundryCustomer().setVisible(true);
            }
        });
    }
